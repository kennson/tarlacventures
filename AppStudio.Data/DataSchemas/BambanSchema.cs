...
{
    /// <summary>
    /// Implementation of the BambanSchema class.
    /// </summary>
    public class BambanSchema : BindableSchemaBase, IEquatable<BambanSchema>, ISyncItem<BambanSchema>
    {
        ...
        public bool Equals(BambanSchema other)
        {
        ...
        public bool NeedSync(BambanSchema other)
        {
        ...
        public void Sync(BambanSchema other)
        {
        ...
        {
            return Equals(obj as BambanSchema);
        }
