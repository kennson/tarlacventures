...
{
    public class FacebookSchema : BindableSchemaBase, IEquatable<FacebookSchema>, IComparable<FacebookSchema>
    {
        ...
        {
            return Equals(obj as FacebookSchema);
        }
        ...
        public int CompareTo(FacebookSchema other)
        {
