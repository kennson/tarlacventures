...
{
    /// <summary>
    /// Implementation of the CapasSchema class.
    /// </summary>
    public class CapasSchema : BindableSchemaBase, IEquatable<CapasSchema>, ISyncItem<CapasSchema>
    {
        ...
        public bool Equals(CapasSchema other)
        {
        ...
        public bool NeedSync(CapasSchema other)
        {
        ...
        public void Sync(CapasSchema other)
        {
        ...
        {
            return Equals(obj as CapasSchema);
        }
